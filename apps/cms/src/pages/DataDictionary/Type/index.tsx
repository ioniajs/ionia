    ...
    const columns: ProColumns<DataDictionaryTypePageVO>[] = [
                    ...
                    <Space className='deleteTime-filterDropDown__space' size={40}>
                        <Button
                            ...
                            onClick={() => {
                                ...
                                const beginUpdateTime = moment(time[0]).format(
                                    'YYYY-MM-DD'
                                ) + ' 00:00:00';
                                const endUpdateTime = moment(time[1]).format(
                                    'YYYY-MM-DD'
                                ) + ' 00:00:00';
                                console.log(beginUpdateTime, endUpdateTime);
                                setSearchParams({ ...searchParams, beginUpdateTime, endUpdateTime })
                            }}
                            icon={<SearchOutlined />}
                            size='small'
                            style={{ width: 120 }}
        ...
        },
        {
            ...
            render: (_, row) => {
                return (
                    <>
                        <a>字典数据</a><Divider type="vertical" />
