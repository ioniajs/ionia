        ...
        <div className='io-cms-content-archive-container'>
                        ...
                        <BizModalForm
                            ...
                            submitterRender={() => (
                                <>
                                    ...
                                    <Button
                                        type='primary'
                                        onClick={() => { modalRef.current?.close(); setOutGoOtherVisible(true) }}
                                    >
                                        出档到其他栏目
                                    </Button>
                                </>
                            ...
                            width={1015}
                        >
                            <OutForm onChange={(selectedRowKeys) => setOutSelectRowKeys(selectedRowKeys)} />
                        </BizModalForm>
            ...
            <Modal
                ...
                footer={[
                    ...
                    <Button key='submit' type='primary' >出档</Button>
                ]}
                width={496}
