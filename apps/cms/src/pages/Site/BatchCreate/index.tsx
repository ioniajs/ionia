...
export default () => {
	const columns = [
		...
		},
		{
			...
			render: (_: any, row: any) => {
				return <Switch checkedChildren='开启' unCheckedChildren='关闭' defaultChecked={true} />
			},
			editable: false,
		},
	...
	return (
		...
		>
			...
			<EditableTable
				operationRender={(
					{ dataSource, setDataSource, changeData, deleteData }) => ({
						title: '操作',
						dataIndex: 'operation',
				...
				columns={columns}
				dataSource={[{ key: '0', name: '站点名称', dir: '站点目录', modalPath: '模板路径', domain: ['11111'], sortNo: 0, status: 1 }]}
			/>
		</BizPage>
	);
};
