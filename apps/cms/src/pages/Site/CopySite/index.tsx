...
const selectBefore = (
    <Select defaultValue='http://' className='select-before'>
        <Option value='http://' key={1}>http://</Option>
        <Option value='https://' key={2}>https://</Option>
    </Select>
);
                            ...
                            {fields.map((field, index) => {
                                return (
                                    <Form.Item
                                        ...
                                        label={index === 0 ? <span><span className='io-cms-site-copy-label-mark__span'>*</span>域名</span> : ''}
                                        required={false}
                                        key={field.key}
                                    >
                                        <Form.Item
                                            ...
                                            noStyle
                                        >
                                            <Input placeholder="请输入域名" style={{ width: '81%' }} addonBefore={selectBefore} />
                                        </Form.Item>
