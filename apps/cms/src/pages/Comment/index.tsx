...
import { QueryFilter, ProFormSelect, ProFormDateTimeRangePicker, ProFormText } from '@ant-design/pro-form';
import './index.less';
        ...
        <BizPage>
            <div className='io-cms-comment-container'>
                ...
                <div className='io-cms-content-search__div'>
                    <QueryFilter
                        span={6} defaultCollapsed={false} onFinish={async values => { console.log(values) }}>
                        <ProFormSelect
                            name='sortWay'
                            label='排序方式'
                            valueEnum={sortWay}
                        ...
                        <ProFormSelect
                            ...
                            wrapperCol={{ span: 16 }}
                        />
                        <Form.Item name='section' label='所属栏目' labelCol={{ span: 4 }} wrapperCol={{ span: 16 }}>
                        ...
                        <ProFormDateTimeRangePicker
                            ...
                            wrapperCol={{ span: 22 }}
                        />
                        <ProFormDateTimeRangePicker name='replyTime' label='回复时间' labelCol={{ span: 4 }} wrapperCol={{ span: 22 }} />
                        <ProFormText
                            name='searchKeyWord'
                            fieldProps={{
