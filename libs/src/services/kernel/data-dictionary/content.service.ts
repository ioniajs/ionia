 ...
 * @param params 
 */
export async function dataDictionaryPaging(params:DataDictionaryPaging): Promise<JcResult<Page<DataDictionaryPageVO>>> {
 ...
 * @param data 
 */
export async function updateDataDictionary(data:DataDictionaryUpdateDTO): Promise<JcResult<boolean>>{
