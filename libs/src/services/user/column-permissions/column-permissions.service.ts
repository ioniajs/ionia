...
import { DataChannelVO } from './column-permissions.vo';
 ...
 * 根据角色id获取栏目权限数据
 */
export async function roleGainCloumn(params: OrganizationGainCloumn): Promise<JcResult<object>> {
 ...
 * 根据用户id获取栏目权限数据
 */
export async function userGainCloumn(params: OrganizationGainCloumn): Promise<JcResult<object>> {
