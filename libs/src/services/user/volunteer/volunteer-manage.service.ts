 ...
 * @param params 
 */
export async function volunteerPaging(params:VolunteerPaging): Promise<JcResult<Page<VolunteerPageVO>>> {
 ...
 * @param params 
 */
export async function uniqueUserNameVolunteers(params:VolunteersUserName): Promise<JcResult<boolean>> {
    return request.get('/module-user/cmsmanager/volunteers/phone/unique', {
        params
    })
}
 ...
 * @param params 
 */
export async function VolunteerPraiseSelectList(params:VolunteerPraiseSelect): Promise<JcResult<VolunteerListVO>> {
