 ...
 * @param params 
 */
export async function volunteerPraisePaging(params:VolunteerPraisePagingProps): Promise<JcResult<Page<PraisePageVO>>>  {
 ...
 * @param data 
 */
export async function updateVolunteerPraiseConfig(data:PraiseConfigDTO): Promise<JcResult<object>> {
