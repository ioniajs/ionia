...
import { AdminVolunteerTeamTreeVO, VolunteerTeamCheckPageVO, AdminVolunteerTeamDetailVO } from './volunteer-teams.vo';
 ...
 * @param params 
 */
export async function allTreeTeamsVolunteer(params:AdminVolunteerTeamTreeVOProps): Promise<JcResult<List<AdminVolunteerTeamTreeVO>>> {
 ...
 * @param params 
 */
export async function volunteerTeamsCheckPaging(params:VolunteerTeamCheckPageVOProps): Promise<JcResult<Page<VolunteerTeamCheckPageVO>>> {
 ...
 * @param params 
 */
export async function uniqueEmailVolunteersTeams(params:VolunteersTeamsEmail): Promise<JcResult<boolean>>  {
 ...
 * @param params 
 */
export async function uniqueUserNameVolunteersTeams(params:VolunteersTeamsEmail): Promise<JcResult<boolean>>  {
 ...
 * @param data 
 */
export async function updateVolunteerTeams(data:AdminVolunteerTeamDTO): Promise<JcResult<boolean>> {
