...
export const AnnexUpload = ({
    ...
    defaultFileList = [
        {
            ...
            status: 'done',
            url:
                'https://pic.tolvyo.com/mTGbnEE3gi-bef0c0d3b52049fbf7008437355bbbc1.jpg',
            size: 200,
            type: 'image/jpg',
            thumbUrl:
    ...
    const Item = SortableElement(({ file }: AnnexUploadItemProps) => (
        <div className='io-annex-upload__list-item'><AnnexUploadItem file={file} /></div>
    ));
    ...
    return (
        <div className='io-annex-upload'>
            ...
            <List helperClass='io-sortable-helper'
                items={fileList}
                axis='xy'
                onSortEnd={onSortEnd}
                distance={20}
