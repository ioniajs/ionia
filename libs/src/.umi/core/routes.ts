...
export function getRoutes() {
  const routes = [
  {
    ...
    "routes": [
      {
        "path": "/env",
        "component": require('../../../docs/env.md').default,
        "exact": true,
        "meta": {
          ...
          "slugs": [
            ...
            {
              "depth": 3,
              "value": "git 本地与服务器进行绑定",
              "heading": "git-本地与服务器进行绑定"
            },
            {
              "depth": 3,
              "value": "将项目从 GitHub 克隆下来",
              "heading": "将项目从-github-克隆下来"
            },
            {
              "depth": 3,
              "value": "项目提交步骤",
            ...
            {
              "depth": 3,
              "value": "安装 Commitizen cli 工具",
              "heading": "安装-commitizen-cli-工具"
            }
          ]
        },
        "title": "环境搭建"
